    ...
    this.responseText = `{
      "CF": {
        ...
        "1.0": {
          ...
          "sig": "MEYCIQCIBUSYF7vWWEuy1xAa5mBe+ot9GxJE8FMxSnqCGw7K1QIhALHnL1Wk3MFEkbOD6tW9O9M6vXTxJ0JOepbjCjoLyN4e"
        },
        "hkdf": {
          "H": "${hkdfH}",
...
window.P256_Generator = "BGsX0fLhLEJH+Lzm5WOkQPJ3A32BLeszoPShOUXYmMKWT+NC4v4af5uO5+tKfA+eFivOM1drMV7Oy7ZAaDe/UfU=";
window.testG = window.P256_Generator;
window.testH = "BHOPNAWXRi4r/NEptOiLOp8MSwcX0vHrVDRXv16Jnowc1eXXo5xFFKIOI6mUp8k9/eca5VY07dBhAe8QfR/FSRY=";
window.testDevG = window.P256_Generator;
window.testDevH = "BKjGppSCZCsL08YlF4MJcml6YkCglMvr56WlUOFjn9hOKXNa0iB9t8OHXW7lARIfYO0CZE/t1SlPA1mXdi/Rcjo=";
window.testSigG = window.P256_Generator;
